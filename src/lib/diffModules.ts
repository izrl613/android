...
export const DIFF_MODULES: DiffModule[] = [
  ...
  },
  {
    ...
    vector: 'V-05',
    icon: '◯',
    label: 'Non-Mobile OS Privacy Audit',
    ...
    capabilities: [
      'Detect supported non-mobile OS platforms (macOS, Windows, Linux)',
      'Estimate cache, log, download, and browser-cache footprint',
      'Identify memory pressure and local disk hygiene signals',
      'Generate review-only cleanup candidates',
      'Bridge to privacy-audit MCP read-only tools in Antigravity/Continue',
      'Require explicit review before moving anything to Trash',
    ],
    nukedTriggers: ['Unsupported OS scan context', 'High cache/log footprint requiring review', 'Browser cache surface exceeds threshold'],
    knoxedTriggers: ['Read-only audit completed', 'Cleanup candidates reviewed', 'No high-footprint cache/log path detected'],
    severity: 79,
    nukedCount: 4,
    knoxedCount: 9,
    monitoredCount: 7,
    weight: 0.1,
    integratedWith: ['privacy-audit MCP', 'Antigravity Continue', 'Local OS telemetry'],
  },
  {
    id: 'deep-web',
    vector: 'V-06',
